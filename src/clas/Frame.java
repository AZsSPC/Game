...
public class Frame extends javax.swing.JFrame {
 ...
 private void formKeyPressed(java.awt.event.KeyEvent evt) {
  ...
  switch (evt.getKeyCode()) {
   case 87:
    if (ScreenPos[1] - StepLength >= 0) {
     ScreenPos[1] -= StepLength;
    }
    break;
   case 65:
    if (ScreenPos[0] - StepLength >= 0) {
     ScreenPos[0] -= StepLength;
    }
    break;
   case 83:
    if (ScreenPos[1] + StepLength <= GameScreen[1] - ScreenBounds[1]) {
     ScreenPos[1] += StepLength;
    }
    break;
   case 68:
    if (ScreenPos[0] + StepLength <= GameScreen[0] - ScreenBounds[0]) {
     ScreenPos[0] += StepLength;
    }
    break;
   default:
